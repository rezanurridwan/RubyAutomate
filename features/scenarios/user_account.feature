...
When I enter from data test for the username "VALID_USERNAME" and password "PASSWORD"
...
Given I am on the login page
When I enter from data test for the username "LOCKED_USERNAME" and password "PASSWORD"
When I click button login in login page
